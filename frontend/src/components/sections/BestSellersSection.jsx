  ...
  return (
    <section className="bg-stone-50 py-12 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Spotlight Grid - Controlled compact width */}
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center max-w-4xl mx-auto">
          
          {/* Left: Compact Image Spotlight (col-span-5) */}
          <div className="lg:col-span-5 max-w-xs mx-auto lg:max-w-none w-full">
            <div className="relative aspect-[4/5] overflow-hidden bg-gray-100 rounded-sm shadow-sm">
              {displayedProduct && (
                <div key={displayedProduct.id} className="h-full w-full animate-image-reveal">
                  <img
          ...
          <div className="lg:col-span-7 space-y-4 text-center lg:text-left">
            <div key={`info-${current.id}`} className="space-y-3 animate-fade-in-up">
        ...
        {/* Numbered Navigation (Shorter spacing) */}
          ...
          {products.map((product, index) => {
            ...
            return (
              <button
                key={product.id}
                onClick={() => {
                  if (index !== activeIndex && !isTransitioning) setActiveIndex(index);
                }}
